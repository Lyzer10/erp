  ...
  return (
    <div className="flex h-screen flex-col bg-slate-100 font-sans text-slate-800">
      ...
      <header className="flex h-16 items-center justify-between bg-white px-6 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Customer Facing Screen</p>
          </div>
        </div>
        ...
        {hasItems ? (
          <>
            ...
            <div className="flex-1 flex flex-col justify-between p-6 overflow-hidden">
              <div className="flex-1 overflow-y-auto space-y-3 pr-2">
                <h2 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">Scanned Items</h2>
            ...
            <div className="w-96 bg-white border-l border-slate-200 p-6 flex flex-col justify-between shadow-2xl relative z-10">
              <div className="space-y-4">
                <div className="border-b border-slate-100 pb-3 mb-2">
                  <h2 className="text-xs font-bold uppercase tracking-wider text-slate-400">Cart Summary</h2>
                  <p className="text-sm font-semibold text-slate-700 mt-1">Customer: {cartData.customer}</p>
                </div>
              ...
              <div className="border-t border-slate-100 pt-4 space-y-4">
                ...
                <div className="rounded-2xl bg-[#1f9c88]/10 text-center py-3 text-xs font-bold text-[#1f9c88] animate-pulse">
                  Please proceed with payment at the cashier counter.
                </div>
              </div>
            </div>
          </>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-12 bg-white space-y-4 select-none">
            ...
            <div className="space-y-1 max-w-sm">
              <h2 className="text-lg font-bold text-slate-800">Welcome to DeveleERP Shop</h2>
              <p className="text-xs text-slate-500 font-medium">
                Items will appear here as the cashier scans them. Please wait to finalize your purchase.
              </p>
            </div>
            <div className="pt-8 grid grid-cols-2 gap-4 max-w-md w-full">
              <div className="rounded-xl border border-slate-100 p-3 bg-slate-50/50">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Weekly Promo</p>
                <p className="text-xs font-bold text-slate-700 mt-1">Get 5% Off on Groceries</p>
              </div>
              <div className="rounded-xl border border-slate-100 p-3 bg-slate-50/50">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Customer Care</p>
                <p className="text-xs font-bold text-slate-700 mt-1">Support: +255 754 123 456</p>
              </div>
            </div>
          </div>
        )}
      ...
      <footer className="h-10 bg-slate-200 flex items-center justify-center text-[10px] text-slate-500 font-semibold tracking-wider uppercase border-t border-slate-200">
        Thank you for shopping with us &bull; Asante kwa kufanya biashara nasi
      </footer>
    </div>
  );
}
