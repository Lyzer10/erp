...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Products & Services", description: "Catalog, brands, and product codes.", actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(TabbedPage, { tabs: [{
    ...
    key: "brands",
    label: "Brands & Codes",
    render: () => /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { data: ["Brava", "Northstar", "Helios", "Verde", "Apex"].map((b, k) => ({
      code: `BR-${100 + k}`,
      name: b,
      products: 4 + k * 2,
      active: true
